...
*/
  return (
    ...
    >
        ...
        <button  className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full' onClick={handleGenerateClick}>
            Generate Images
        ...
        <p mt-2 text-neutral-600>Generated images from imagify</p>
